// mix.cpp  -  generated by Sonic/C++ translator.
// Translator written by Don Cross <dcross@intersrv.com>

// This file created: Sat Sep 12 11:59:46 1998
...
{
    {
        ...
        for ( long i=0; ; ++i, t += SampleTime )
        {
            ...
            sample[0] =
                v_inWave1.fetch(int(0), long(i), countdown) +
                v_inWave2.fetch(int(0), long(i), countdown);
            sample[1] =
                v_inWave1.fetch(int(1), long(i), countdown) +
                v_inWave2.fetch(int(1), long(i), countdown);
