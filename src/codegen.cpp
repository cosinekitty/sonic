...
void SonicParse_Statement_For::generateCode ( ostream &o, Sonic_CodeGenContext &x )
{
    x.indent ( o, "{\n" );
    x.pushIndent();
...
void SonicParse_Expression_ArraySubscript::generateCode ( ostream &o, Sonic_CodeGenContext &x )
{
    if ( x.generatingComment )
    {
